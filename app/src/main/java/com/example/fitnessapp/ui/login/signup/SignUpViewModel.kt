...
class SignUpViewModel(private val authHolder: AuthHolder) : ViewModel() {
    ...
    fun onRegistrationClicked(
        ...
        if (login.isNotBlank() && name.isNotBlank() && password.isNotBlank()
            && passwordRepeat.isNotBlank() && passwordRepeat == password) {
